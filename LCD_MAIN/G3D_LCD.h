...
public:
  ...
  void GetRotateSwitch(bool EN1, bool EN2);
  void GetSelectSwitch(int Arrow_Point,int Menu_Point,bool switchsum);
  ...
  bool changeflag,ScrollFlag,non; //Writing lcd trigger
